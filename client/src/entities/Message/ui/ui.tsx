                    ...
                    <ContextMenuTrigger className={cn('flex gap-2', !isMessageFromMe && isFirst && 'flex-col')}>
                        ...
                        <div
                            className={cn('px-5 py-1 relative max-w-[500px] flex items-end gap-3 self-start', {
                                ...
                                'rounded-es-[5px] rounded-ss-[15px] rounded-se-[15px] rounded-ee-[15px]':
                                    !isLast && !isMessageFromMe,
                                'rounded-es-[0px] rounded-ss-[15px] rounded-se-[15px] rounded-ee-[15px] relative before:absolute before:w-[20px] before:h-[15px] before:-bottom-0 before:bg-transparent before:-left-5 before:rounded-br-3xl dark:before:shadow-[13px_0_0_#424242] before:shadow-[13px_0_0_#EEE]':
                                    isLast && !isMessageFromMe,
                                'rounded-es-[15px] rounded-ss-[15px] rounded-se-[15px] rounded-ee-[5px]':
                                    !isLast && isMessageFromMe,
                                'rounded-es-[15px] rounded-ss-[15px] rounded-se-[15px] rounded-ee-[0px] relative before:absolute before:w-[20px] before:h-[15px] before:-bottom-0 before:bg-transparent before:-right-5 before:rounded-bl-3xl dark:before:shadow-[-13px_0_0_#F9F9F9]':
                                    isLast && isMessageFromMe
                            })}
                        >
                            <Typography
