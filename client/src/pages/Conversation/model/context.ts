...
export const { Provider: ConversationProvider, useContext: useConversationCtx } = createZustandContext<ConversationStore>(() => createStore((set, get) => ({
    data: null!,
        ...
        try {
            ...
            set((prev) => ({
                data: {
                    ...prev.data,
                    conversation: {
                        ...prev.data.conversation,
                        messages: [...previousMessages.messages, ...prev.data.conversation.messages]
                    },
