            ...
            <main className='flex dark:bg-primary-dark-200 w-full'>
                ...
                >
                    <aside className='flex flex-col h-screen sticky top-0 p-5 gap-8 bg-dark-side-panel'>
                        ...
                        />
                        <ConversationsList />
                        <Button onClick={handleLogout} className="mt-auto" variant="secondary">Logout</Button>
                    </aside>
                </ResizablePanel>
                <ResizableHandle className="data-[resize-handle-active=pointer]:w-2 w-1 dark:bg-primary-dark-50 dark:hover:bg-primary-50 transition-colors duration-200 ease-in-out"/>
