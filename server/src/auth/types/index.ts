...
import { IUser, UserDocumentType, UserProfileType } from 'src/user/types';
...
export interface IAuthService {
    ...
    getProfile(user: UserDocumentType): Promise<UserProfileType>;
    validateUser(_id: Types.ObjectId | string): Promise<UserDocumentType>;
    getProfile(user: UserDocumentType): Promise<Omit<IUser, 'accessToken' | 'expiersIn' | 'password'>>;
